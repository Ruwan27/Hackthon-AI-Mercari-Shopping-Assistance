...
- **Stay truthful** — every product, price, image and link is grounded in live
  Rakuten API results; structured card data bypasses the model entirely
...
│ • per-request session → Rakuten Ichiba Item Search API
...
│ • structured <products> extraction; thumbnails upscaled via Rakuten's CDN
